...
temp_label =tk.Label (root ,text="...",font =("arial",70 ,"bold"),fg="#e355cd")
temp_label.place (x=590 ,y=170)

condition_label =tk.Label (root ,text="...",font =("arial",15 ,"bold"),fg="#4b4bcc")
